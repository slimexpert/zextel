"""
Django settings for zextel project.
...
SECRET_KEY = '@5#r2px+h3v4fe*se^vq&=r^^38b!!o-xys__xcchbzo*-bn+7'
...
WSGI_APPLICATION = 'zextel.wsgi.application'
